...
about:
  ...
  links:
    - icon: display
      text: Slides
      href: https://lennartwittkuhn.com/version-control-course-uni-wuerzburg-2025/sessions/slides-session-command-line.html
      aria-label: display
    - icon: book
      text: Chapter
...
```{=html}
<iframe width="100%" height=500 src="slides-session-command-line.html"></iframe>
```
