...
about:
  ...
  links:
    - icon: display
      text: Slides
      href: https://lennartwittkuhn.com/version-control-course-uni-wuerzburg-2025/sessions/slides-session-outlook.html
      aria-label: display
...
```{=html}
<iframe width="100%" height=500 src="slides-session-outlook.html"></iframe>
```
