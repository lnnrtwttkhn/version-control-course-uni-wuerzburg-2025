...
about:
  ...
  links:
    - icon: display
      text: Slides
      href: https://lennartwittkuhn.com/version-control-course-uni-wuerzburg-2025/sessions/slides-session-git-basics.html
      aria-label: display
    - icon: book
...
```{=html}
<iframe width="100%" height=500 src="slides-session-git-basics.html"></iframe>
```
