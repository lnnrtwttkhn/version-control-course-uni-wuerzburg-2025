...
about:
  ...
  links:
    - icon: display
      text: Slides
      href: https://lennartwittkuhn.com/version-control-course-audictive-2025/sessions/slides-session-git-branches.html
      aria-label: display
    - icon: book
...
```{=html}
<iframe width="100%" height=500 src="slides-session-git-branches.html"></iframe>
```
